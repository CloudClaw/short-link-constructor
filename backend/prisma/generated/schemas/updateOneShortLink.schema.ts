...
export const ShortLinkUpdateOneSchema: z.ZodType<Prisma.ShortLinkUpdateArgs> = z.object({ select: ShortLinkSelectObjectSchema.optional(),  data: z.union([ShortLinkUpdateInputObjectSchema, ShortLinkUncheckedUpdateInputObjectSchema]), where: ShortLinkWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.ShortLinkUpdateArgs>;

export const ShortLinkUpdateOneZodSchema = z.object({ select: ShortLinkSelectObjectSchema.optional(),  data: z.union([ShortLinkUpdateInputObjectSchema, ShortLinkUncheckedUpdateInputObjectSchema]), where: ShortLinkWhereUniqueInputObjectSchema }).strict();