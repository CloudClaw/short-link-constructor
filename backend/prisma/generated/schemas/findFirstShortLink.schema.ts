...
export const ShortLinkFindFirstSelectSchema: z.ZodType<Prisma.ShortLinkSelect> = z.object({
...
export const ShortLinkFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    originalLink: z.boolean().optional(),
    shortLink: z.boolean().optional(),
    userId: z.boolean().optional(),
...
export const ShortLinkFindFirstSchema: z.ZodType<Prisma.ShortLinkFindFirstArgs> = z.object({ select: ShortLinkFindFirstSelectSchema.optional(), include: z.lazy(() => ShortLinkIncludeObjectSchema.optional()), orderBy: z.union([ShortLinkOrderByWithRelationInputObjectSchema, ShortLinkOrderByWithRelationInputObjectSchema.array()]).optional(), where: ShortLinkWhereInputObjectSchema.optional(), cursor: ShortLinkWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ShortLinkScalarFieldEnumSchema, ShortLinkScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ShortLinkFindFirstArgs>;

export const ShortLinkFindFirstZodSchema = z.object({ select: ShortLinkFindFirstSelectSchema.optional(), include: z.lazy(() => ShortLinkIncludeObjectSchema.optional()), orderBy: z.union([ShortLinkOrderByWithRelationInputObjectSchema, ShortLinkOrderByWithRelationInputObjectSchema.array()]).optional(), where: ShortLinkWhereInputObjectSchema.optional(), cursor: ShortLinkWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ShortLinkScalarFieldEnumSchema, ShortLinkScalarFieldEnumSchema.array()]).optional() }).strict();