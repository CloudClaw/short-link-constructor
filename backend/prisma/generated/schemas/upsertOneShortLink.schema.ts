...
export const ShortLinkUpsertOneSchema: z.ZodType<Prisma.ShortLinkUpsertArgs> = z.object({ select: ShortLinkSelectObjectSchema.optional(),  where: ShortLinkWhereUniqueInputObjectSchema, create: z.union([ ShortLinkCreateInputObjectSchema, ShortLinkUncheckedCreateInputObjectSchema ]), update: z.union([ ShortLinkUpdateInputObjectSchema, ShortLinkUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.ShortLinkUpsertArgs>;

export const ShortLinkUpsertOneZodSchema = z.object({ select: ShortLinkSelectObjectSchema.optional(),  where: ShortLinkWhereUniqueInputObjectSchema, create: z.union([ ShortLinkCreateInputObjectSchema, ShortLinkUncheckedCreateInputObjectSchema ]), update: z.union([ ShortLinkUpdateInputObjectSchema, ShortLinkUncheckedUpdateInputObjectSchema ]) }).strict();