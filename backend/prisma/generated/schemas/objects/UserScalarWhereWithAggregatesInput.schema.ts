...
const userscalarwherewithaggregatesinputSchema = z.object({
  ...
  email: z.union([z.lazy(() => StringWithAggregatesFilterObjectSchema), z.email()]).optional(),
  password: z.union([z.lazy(() => StringWithAggregatesFilterObjectSchema), z.string().min(6)]).optional(),
